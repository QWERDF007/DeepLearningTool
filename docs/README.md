...
| 查看当前代码结构、运行链路和架构风险 | [代码结构分析](分析.md) |
| 查看可交互架构图与源码证据 | [系统架构图](系统架构图.html) |
| 按阶段实施架构改进并核对验收范围 | [架构收敛实施规格](REFACTOR_SPEC.md) |
| 领取具有明确依赖和验收条件的开发任务 | [架构收敛任务](refactor-tickets/README.md) |
