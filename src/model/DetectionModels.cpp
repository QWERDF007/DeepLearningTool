                                                           ...
                                                           const bool mosaic_enabled)
{
    ...
    train_group.params = {
        ...
        makeDoubleParam(QStringLiteral("learning_rate"), QStringLiteral("Learning Rate"), 0.01, 0.000001, 1.0,
                        0.0001, 6),
    ...
    augmentation_group.params = {
        ...
        makeSliderParam(QStringLiteral("flip_probability"), QStringLiteral("Flip Probability"), 0.5, 0.0, 1.0,
                        0.01, 2),
    };
...
std::vector<ParamGroupDefinition> makeDetectionTestGroups(const int image_size)
{
    ...
    inference_group.params = {
        ...
        makeSliderParam(QStringLiteral("confidence_threshold"), QStringLiteral("Confidence Threshold"), 0.25, 0.0,
                        1.0, 0.01, 2),
        makeSliderParam(QStringLiteral("nms_threshold"), QStringLiteral("NMS Threshold"), 0.45, 0.0, 1.0, 0.01,
                        2),
    };
