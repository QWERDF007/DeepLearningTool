...
// generated by 3rdparty/sqlpp11/scripts/sqlite2cpp.py src/database/include/database/ddl/create_ui_settings.sql src/database/include/database/ddl/UiSettingsTable dltool::database
...
namespace database
{
  ...
  struct UiSettings: sqlpp::table_t<UiSettings,
               UiSettings_::Id,
               UiSettings_::Key,
               UiSettings_::Value,
               UiSettings_::Mtime>
  {
    struct _alias_t
    {
      static constexpr const char _literal[] =  "ui_settings";
      using _name_t = sqlpp::make_char_sequence<sizeof(_literal), _literal>;
      template<typename T>
      struct _member_t
      {
        T uiSettings;
        T& operator()() { return uiSettings; }
        const T& operator()() const { return uiSettings; }
      };
    };
  };
} // namespace database
